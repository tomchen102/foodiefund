...
const recentProjectsBlockData = async () => {
  return [
    {
      id: 1,
      title: "咖啡與時光",
...
export default async function ProjectsLayout({ children }: ProviderProps) {
  ...
  metadata.title = ProjectSummaryData.title;
  metadata.description = ProjectSummaryData.description;
  metadata.openGraph = metadata.openGraph ?? {};
  metadata.openGraph.title = ProjectSummaryData.title;
  metadata.openGraph.description = ProjectSummaryData.description;
  metadata.openGraph.url = "https://foodiefund.vercel.app/projects/123";
  ...
  metadata.twitter.title = ProjectSummaryData.title;
  metadata.twitter.description = ProjectSummaryData.description;
