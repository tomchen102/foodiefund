  ...
  return (
    <section className="container px-3 pb-12 pt-8 md:pb-[120px] md:pt-20 xl:px-0">
      <div className="mb-3 flex md:mb-6">
        <h2 className="text-lg font-bold text-[#09090B] md:text-2xl">募資提案經驗談</h2>
          ...
          <li key={item.id} className="relative">
            <div className="drop-shadow-[0px_4px_4px_rgba(0,0,0,0.15)]">
              <div className="clip-polygon mb-4 h-[440px] rounded-lg bg-[#E2E8E6] px-5 pt-5">
                ...
                <h3 className="mb-3 font-bold leading-6 text-[#09090B]">{item.title}</h3>
                <p className="text-sm font-medium text-[#09090B]">{item.description}</p>
              </div>
            </div>
            ...
            <div className="absolute bottom-0 flex">
              ...
              <div>
                <h4 className="mb-1 text-sm font-bold text-[#09090B]">{item.avatarName}</h4>
