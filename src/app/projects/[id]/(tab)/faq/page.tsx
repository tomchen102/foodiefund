...
const Faq = () => {
  return (
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem className="mb-5 border-l border-r border-t p-6" value="item-1">
      ...
      <AccordionItem className="mb-5 border-l border-r border-t p-6" value="item-2">
        <span className="mb-1 block text-gray">更新於 2024/08/10 13:53</span>
      ...
      <AccordionItem className="mb-5 border-l border-r border-t p-6" value="item-3">
        <span className="mb-1 block text-gray">更新於 2024/08/10 13:53</span>
        <AccordionTrigger className="hover:text-primary-dark hover:no-underline md:text-2xl">
          Q: 我的投資將如何使用？
        </AccordionTrigger>
      ...
      <AccordionItem className="mb-5 border-l border-r border-t p-6" value="item-4">
        <span className="mb-1 block text-gray">更新於 2024/08/10 13:53</span>
        <AccordionTrigger className="hover:text-primary-dark hover:no-underline md:text-2xl">
          Q: 投資回報是什麼？
        </AccordionTrigger>
      ...
      <AccordionItem className="mb-5 border-l border-r border-t p-6" value="item-5">
        <span className="mb-1 block text-gray">更新於 2024/08/10 13:53</span>
        <AccordionTrigger className="hover:text-primary-dark hover:no-underline md:text-2xl">
          Q: 如果募資未達標怎麼辦？
        </AccordionTrigger>
      ...
      <AccordionItem className="mb-5 border-l border-r border-t p-6" value="item-6">
        <span className="mb-1 block text-gray">更新於 2024/08/10 13:53</span>
        <AccordionTrigger className="hover:text-primary-dark hover:no-underline md:text-2xl">
          Q: 餐廳何時開業？
        </AccordionTrigger>
      ...
      <AccordionItem className="mb-5 border-l border-r border-t p-6" value="item-7">
        <span className="mb-1 block text-gray">更新於 2024/08/10 13:53</span>
        <AccordionTrigger className="hover:text-primary-dark hover:no-underline md:text-2xl">
          Q: 我如何參與餐廳的決策？
        </AccordionTrigger>
      ...
      <AccordionItem className="mb-5 border-l border-r border-t p-6" value="item-8">
        <span className="mb-1 block text-gray">更新於 2024/08/10 13:53</span>
        <AccordionTrigger className="hover:text-primary-dark hover:no-underline md:text-2xl">
          Q: 我如何了解最新進展？
        </AccordionTrigger>
      ...
      <AccordionItem className="mb-5 border-l border-r border-t p-6" value="item-9">
        <span className="mb-1 block text-gray">更新於 2024/08/10 13:53</span>
        <AccordionTrigger className="hover:text-primary-dark hover:no-underline md:text-2xl">
          Q: 群眾募資餐廳的風險是什麼？
        </AccordionTrigger>
