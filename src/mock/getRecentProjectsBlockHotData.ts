...
export const getRecentProjectsBlockHotData = async (): Promise<RecentProjectsProps[]> => {
  return [
    ...
    },
    {
      ...
      title: "族味傳奇",
      description:
        "族味傳奇帶您走進多元文化的美食世界，品味來自各民族的經典風味。這裡的料理匯聚了傳統的手工技藝和地道食材，讓每一道菜肴都充滿歷史故事與家鄉情懷。不論是濃郁的炖湯還是香嫩的烤肉，每一口都在講述不同族群的美食傳奇。來這裡，探索和體驗各地美食的深厚魅力，感受文化交織下的美味饗宴。傳承台東原住民飲食文化,呈現地道的傳統風味與文化故事。",
      imageUrl:
